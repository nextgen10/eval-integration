...
export const UbsLogoFull: React.FC<UbsLogoFullProps> = ({
  ...
  return (
    ...
    >
      <path d={UBS_WORDMARK_PATH} fill={wordmarkColor} />
      <path d={UBS_KEYS_PATH} fill={keysColor} />
    </svg>
  );
};
