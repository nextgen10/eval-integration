...
export default function GroundTruthLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <AuthGuard>
      <Box sx={{ display: 'flex', flexDirection: 'column', height: '100vh', overflow: 'hidden', bgcolor: 'background.default', color: 'text.primary' }}>
        <UnifiedNavBar
          ...
          actions={
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
              ...
              />
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, ml: { md: 2 } }}>
