...
export default function HistoryPage() {
    ...
    return (
        <Box sx={{ display: 'flex', minHeight: '100vh' }}>
            <Sidebar />
            <Box component="main" sx={{ flexGrow: 1, ml: `${sidebarWidth}px`, transition: 'margin-left 0.3s ease-in-out', height: '100vh', display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
