...
// UBS brand font – Audela (add Audela-Bold.woff2 to public/fonts/)
...
export const getUnifiedTheme = (mode: 'light' | 'dark') => {
  ...
  return createTheme({
    palette: {
      ...
      divider: mode === 'dark' ? c.border.subtle : c.border.subtle,
    },
    typography: {
      ...
      MuiButton: {
        styleOverrides: {
          ...
          containedSecondary: {
            ...
            color: '#fff',
            '&:hover': {
              backgroundColor: c.secondary.hover,
            },
          },
          outlined: {
            borderWidth: 1,
          ...
          text: {
            '&:hover': {
              backgroundColor: alpha(c.primary.main, 0.06),
            },
          },
          sizeSmall: {
            fontSize: '0.8125rem',
      ...
      MuiIconButton: {
        styleOverrides: {
          root: {
            ...
            transition: 'all 0.2s ease-in-out',
            '&:hover': {
              backgroundColor: alpha(c.primary.main, 0.08),
            },
          },
        },
      },
