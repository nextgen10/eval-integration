...
import { MessageSquare, Send, Star, ThumbsUp, Bug, Lightbulb, Zap, CheckCircle, AlertCircle, Bot } from 'lucide-react';
...
export function FeedbackView() {
    ...
    const categories = [
        { id: 'general', label: 'General', icon: MessageSquare, color: '#2196f3' },
                                                ...
                                                <Paper
                                                    ...
                                                    sx={{
                                                        ...
                                                        '&:hover': {
                                                            ...
                                                            boxShadow: `0 2px 8px ${alpha(cat?.color || '#2196f3', 0.2)}`
                                                        }
                                                    }}
                                                >
                                                    <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', mb: 0.5 }}>
                                                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5 }}>
                                                            <Icon size={14} style={{ color: cat?.color || '#2196f3' }} />
                                                            <Chip
                                                                ...
                                                                sx={{
                                                                    height: '16px',
                                                                    fontSize: '0.6875rem',
                                                                    backgroundColor: alpha(cat?.color || '#2196f3', 0.1),
