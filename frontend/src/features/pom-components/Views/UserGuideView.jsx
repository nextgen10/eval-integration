...
import {
    Book, Rocket, Bug, Lightbulb, CheckCircle, Play, Code,
    FolderOpen, Terminal, HelpCircle, Star, TrendingUp,
    ChevronRight, Zap, Settings, MousePointer, Camera, FileCode,
    Sparkles, Video, Target, Activity, Wand2
} from 'lucide-react';
            ...
            <Box sx={{
                ...
                <Box sx={{ pt: 1 }}>
                    ...
                    <Typography variant="subtitle1" color="text.secondary">
                        Complete guide to using the Playwright POM Framework
                    </Typography>
                </Box>
                            ...
                            <Box sx={{ flex: 1, maxWidth: '850px' }}>
                                ...
                                <Box ref={el => sectionRefs.current['introduction'] = el} sx={{ mb: 6 }}>
                                    <Typography variant="h6" sx={styles.sectionTitle}>
                                        <Book size={24} color={theme.palette.primary.main} />
                                        Introduction
                                    </Typography>
                                    ...
                                    <Grid container spacing={3} sx={{ mt: 1, mb: 3 }}>
                                        {[
                                            ...
                                            { icon: MousePointer, title: 'No-Code Recording', desc: 'Record browser interactions naturally - no coding required during recording', color: '#2196f3' },
                                ...
                                <Box ref={el => sectionRefs.current['getting-started'] = el} sx={{ mb: 6 }}>
                                    ...
                                    <Paper variant="outlined" sx={{ p: 3, mb: 2.5, bgcolor: 'background.paper', borderRadius: 2 }}>
                                        ...
                                        <Box sx={styles.codeBlock('#10b981')}>
                                    ...
                                    <Paper variant="outlined" sx={{ p: 3, mb: 2.5, bgcolor: 'background.paper', borderRadius: 2 }}>
                                        ...
                                        <Alert severity="info" sx={{ mt: 2 }}>
                                            <Typography variant="body2">
                                                ...
                                                • Gemini: Visit <a href="https://makersuite.google.com/app/apikey" target="_blank" rel="noopener">Google AI Studio</a><br />
                                                • OpenAI: Visit <a href="https://platform.openai.com/api-keys" target="_blank" rel="noopener">OpenAI Platform</a>
                                            </Typography>
                                        </Alert>
                                    </Paper>
                                    ...
                                    <Grid container spacing={2}>
                                        <Grid item xs={12} md={6}>
                                            <Paper variant="outlined" sx={{ p: 2, borderRadius: 2 }}>
                                                ...
                                                <Box sx={styles.codeBlock('#2196f3')}>
                                                    cd studio/backend<br />
                                ...
                                <Box ref={el => sectionRefs.current['test-studio'] = el} sx={{ mb: 6 }}>
                                    ...
                                    <Grid container spacing={2}>
                                        <Grid item xs={12} sm={6}>
                                            <Paper sx={{ p: 2.5, borderRadius: 2, height: '100%' }}>
                                                <Typography variant="subtitle2" fontWeight="bold" gutterBottom>
                                                    <Camera size={20} style={{ verticalAlign: 'middle', marginRight: 8 }} />
                                                    Recording
                                                </Typography>
                                                <List dense>
                                        ...
                                        <Grid item xs={12} sm={6}>
                                            <Paper sx={{ p: 2.5, borderRadius: 2, height: '100%' }}>
                                                <Typography variant="subtitle2" fontWeight="bold" gutterBottom>
                                                    <FileCode size={20} style={{ verticalAlign: 'middle', marginRight: 8 }} />
                                                    Code Generation
                                                </Typography>
                                                <List dense>
                                                    <ListItem sx={{ px: 0, py: 0.35 }}>
                                ...
                                <Box ref={el => sectionRefs.current['architecture'] = el} sx={{ mb: 6 }}>
                                    <Typography variant="h6" sx={styles.sectionTitle}>
                                        <FolderOpen size={24} color="#00bcd4" />
                                        System Architecture
                                    </Typography>
                                    <Typography paragraph color="text.secondary">
                                ...
                                <Box ref={el => sectionRefs.current['roi-savings'] = el} sx={{ mb: 6 }}>
                                    ...
                                    <Paper variant="outlined" sx={{ p: 3, borderRadius: 2 }}>
                                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, mb: 3 }}>
                                            <Box sx={{ p: 1, borderRadius: 1, bgcolor: alpha('#2196f3', 0.1), color: '#2196f3', display: 'flex' }}>
                                                <FileCode size={20} />
                                            </Box>
                                        ...
                                        {navigation.map((item) => (
                                            <ListItemButton
                                                ...
                                                sx={{
                                                    position: 'relative',
                                                    pl: 2,
                                                    borderLeft: activeSection === item.id ? `2px solid ${theme.palette.primary.main}` : '2px solid transparent',
                                                    color: activeSection === item.id ? 'primary.main' : (theme) => theme.palette.mode === 'dark' ? 'rgba(255,255,255,0.6)' : 'text.secondary',
                                                    mb: 0.5,
