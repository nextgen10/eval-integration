...
export const AIChatWindow = ({
    ...
    return (
        <div className={`fixed bottom-24 right-6 w-[560px] h-[600px] flex flex-col rounded-3xl border transition-all duration-300 transform animate-in fade-in slide-in-from-bottom-4 ${isDark
            ? 'bg-[#1e1e1e] border-indigo-500/30 ring-1 ring-white/10 shadow-[0_0_100px_rgba(103,58,183,0.5),0_0_200px_rgba(33,150,243,0.3),0_100px_300px_-20px_rgba(0,0,0,1)]'
            : 'bg-white border-indigo-200 ring-1 ring-black/5 shadow-[0_0_80px_rgba(103,58,183,0.3),0_0_160px_rgba(33,150,243,0.2),0_120px_300px_-30px_rgba(0,0,0,0.6)]'
            ...
            <div className={`flex items-center justify-between border-b ${isDark ? 'bg-[#252526] border-[#333]' : 'bg-gray-50 border-gray-200'}`} style={{ minHeight: 66, padding: '12px 20px' }}>
                <div className="flex items-center" style={{ gap: 10 }}>
                    <div className={`w-9 h-9 rounded-full flex items-center justify-center bg-gradient-to-br from-[#673ab7] via-[#2196f3] to-[#673ab7] text-white shadow-lg shadow-indigo-500/20`}>
            ...
            <div className="flex-1 overflow-y-auto custom-scrollbar" style={{ padding: "16px 20px", display: "flex", flexDirection: "column", gap: 12 }}>
                                                        ...
                                                        <div key={i} className="relative rounded-xl overflow-hidden my-3 border border-transparent group/code">
                                                            ...
                                                            <SyntaxHighlighter
                                                                ...
                                                                customStyle={{
                                                                    ...
                                                                    lineHeight: '1.6',
                                                                    background: isDark ? '#09090b' : '#f8f9fa',
                ...
                {isChatTyping && (
                    <div className="flex gap-2.5 animate-in fade-in">
                        <div className={`w-8 h-8 rounded-full flex items-center justify-center bg-[#2196f3] text-white shadow-sm`}>
            ...
            <div className={`border-t ${isDark ? 'border-[#333] bg-[#252526]/50' : 'border-zinc-100 bg-gray-50'}`} style={{ padding: '14px 20px' }}>
                ...
                >
                    ...
                    <button
                        ...
                        className={`mr-1 rounded-xl transition-all hover:scale-105 active:scale-95 bg-gradient-to-br from-[#673ab7] via-[#2196f3] to-[#673ab7] text-white disabled:opacity-50 disabled:scale-100 disabled:cursor-not-allowed shadow-md shadow-indigo-500/20`} style={{ padding: 8 }}
                    >
                        <Send size={18} />
                    </button>
                </form>
